...
export default function TableFaculties({ facultyData, searchText }) {
  ...
  return (
    <div>
      ...
      {data.length === 0 ? (
        ...
        <Column width={80} resizable flexGrow={1}>
              <HeaderCell>Facultad</HeaderCell>
              <EditableCell dataKey="nombre" onChange={handleChange}/>
            </Column>
            ...
            <Column width={300} resizable>
              ...
              <EditableCell dataKey="telefono" onChange={handleChange} />
            </Column>
            <Column width={300} resizable>
              <HeaderCell>Decano</HeaderCell>
              <EditableCell dataKey="decano" onChange={handleChange} />
            </Column>
            <Column width={300} resizable flexGrow={1}>
              <HeaderCell>Pagina web</HeaderCell>
              <EditableCell dataKey="web" onChange={handleChange} />
            </Column>
